...
function createData(role, description) {
  ...
  const rows = [
    // createData('Admin', 'Shell Recharge','Bellandur', 'shell567@gmail.com', '7803820382', true, '87'),
    createData('Admin', 'Manage Charging Stations'),
    createData('Co-Admin', 'Manage Reservations'),
    createData('Support', 'Customer Care')
  ];
...
export default function MyBookingForm() {
  ...
  fontFamily="Poppins">  + Add New Station </Button> */}
        <Fab variant="extended" size="medium" color="primary" aria-label="add" onClick={()=>{history.push({pathname:"/app/addRole"})}}>
        + Add
      </Fab>
    </Box>
    ...
    {/* <Box sx={{ width: '100%' }} style ={{marginTop:"15px"}}> */}
      ...
      <Table sx={{ minWidth: 700 }} aria-label="customized table" >
        <TableHead >
          <TableRow >
            <StyledTableCell style={{fontFamily:"Sora",fontSize:"14pt"}}> Role</StyledTableCell>
            <StyledTableCell style={{fontFamily:"Sora",fontSize:"14pt"}}align="left">Description</StyledTableCell>
