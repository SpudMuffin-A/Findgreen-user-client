...
function createData(id, station, address, email, phone,status, slots) {
    return { id, station, address, email, phone,status, slots};
  }
  
  const rows = [
    createData('CS_101', 'Shell Recharge','Bellandur', 'shell567@gmail.com', '7803820382', true, '87'),
    createData('CS_102', 'Tata Power Recharge','Sadashivanagr', 'tatapower12@gmail.com', '5261723989', true, '102'),
    createData('CS_103', 'Ather Power','BEL Road', 'ather@gmail.com', '9987239319', true, '90'),
    createData('CS_104', 'Adani Electric','MG Road', 'adaniev@gmail.com', '6981928329', false, '113'),
...
export default function MyBookingForm() {
  ...
  fontFamily="Poppins">  + Add New Station </Button> */}
        <Fab variant="extended" size="medium" color="primary" aria-label="add" onClick={()=>{history.push({pathname:"/app/addStation"})}}>
    ...
    <Box sx={{ width: '100%' }} style ={{marginTop:"15px"}}>
      ...
      <Table sx={{ minWidth: 700 }} aria-label="customized table" >
        <TableHead >
          <TableRow >
            <StyledTableCell style={{fontFamily:"Sora",fontSize:"14pt"}}> ID</StyledTableCell>
            <StyledTableCell style={{fontFamily:"Sora",fontSize:"14pt"}}align="left">Charging Station</StyledTableCell>
            <StyledTableCell style={{fontFamily:"Sora",fontSize:"14pt"}}align="left">Address</StyledTableCell>
        ...
        <TableBody>
          {rows.map((row) => (
            <StyledTableRow key={row.datetime}>
              ...
              <StyledTableCell align="left">{row.slots}</StyledTableCell>
            </StyledTableRow>
          ))}
        </TableBody>
      </Table>
